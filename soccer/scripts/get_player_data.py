...
states_cleaned = config.states_cleaned
...
for url, filename in zip(url_list, filename_list):
	config.create_player_txt_file(url, filename)
...
for filename in filename_list:
	...
	indiv_page_players_list = config.create_players_list(filename)
...
filename = "../cleaned_data/mls_players_cleaned.csv"
header =["Player Name", "MLS Club", "Jersey Number", "Position", "Hometown: City", "Hometown: State/Province", "Hometown: Country", "Age", "Height (in.)", "Weight (lbs.)" ]
